...
a = '/home/chen/datasets/Taking phone fromed/Mean Girls Phone Call'

part_num = 'part_2'
#class_choice = 'other_max'
#class_choice = 'other_min'
class_choice = 'talking_max'
#class_choice = 'talking_min'

zero_one = 0
#zero_one = 1

work_path = a + '/' + part_num + '/' + class_choice
