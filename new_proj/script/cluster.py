...
all_pics = []
work_path = '/home/chen/datasets/Taking phone/Call Clash Prank On Girls _ Pranks In India _ Aamir The Liberal Indian _ TLI _ Ft- The Ghatiya Films/part_4/'
work_path_save = '/home/chen/datasets/Taking phone/Call Clash Prank On Girls _ Pranks In India _ Aamir The Liberal Indian _ TLI _ Ft- The Ghatiya Films/part_4/1/'
...
sig = 0
for num, img_path in enumerate(sorted(img_paths)):
    #print(str(img_path))
