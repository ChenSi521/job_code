...
a = '/home/chen/datasets/Taking phone/Call Clash Prank On Girls __ Pranks In India __ Pranks 2018 __ Harsh Chaudhary'

work_path = a + '/part_1/2/'
work_path_save = a +'/part_1/3/'
...
def ff(a, b):
    return int(a.name.split('.')[0]) - int(b.name.split('.')[0])

sig = 0
for num, img_path in enumerate(sorted(img_paths, cmp=ff)):
    #print(str(img_path))
