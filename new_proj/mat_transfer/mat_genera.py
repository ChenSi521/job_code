...
work_path = '/home/chen/datasets/workflow_test/'
work_path1 = '/home/chen/datasets/workflow_test/without_dot/'
csv_name = 'workflow_test.csv'
...
#print(arr_landmark)
frame_names = list(df['frame_name'])
for frame_name in frame_names:
    arr_landmark = np.zeros((68, 2))
    row = df[df.frame_name == frame_name].index.tolist()[0]
    ...
    for i, xy in enumerate(zip(landmarks_x, landmarks_y)):
        arr_landmark[i] = xy
    print(arr_landmark)
    print(type(arr_landmark))

    mat_name = frame_name + '.mat'
    mat_path = work_path1 + mat_name
