...
csv_name = '01030010_flip_cut_aligned.csv'
save_csv_name = '01030010_flip_cut_aligned_step1.csv'
image_save_path = work_path + 'image_save_step1/'
...
dt = df[(df['confidence'] > 0.9) & (df['success'] == 1)]
