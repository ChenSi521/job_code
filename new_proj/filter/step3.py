...
csv_name = '01030010_flip_cut_aligned_step2.csv'
save_csv_name = '01030010_flip_cut_aligned_step3.csv'
...
image_save_path = work_path + 'image_save_step3/'
if not os.path.exists(image_save_path):
    os.makedirs(image_save_path)
df = pd.read_csv(work_path + csv_name, header=0, sep=',', engine='python')
dt = df[(df['pose_Ry'] <= 0.52) & (df['pose_Ry'] >= -0.52)]
